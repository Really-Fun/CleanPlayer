...
class PlaylistPage(QWidget):
    ...
    def __init__(self, app_context: AppContext, parent=None,) -> None:
        ...
        from quantis.models import TrackListModel
    ...
    async def load_playlist(self, playlist) -> None:
        ...
        self._allow_remove = not isinstance(playlist, RecentlyPlayedPlaylist)
    ...
    async def on_remove_from_playlist(self, track) -> None:
        ...
        if not isinstance(self.playlist, RecentlyPlayedPlaylist):
            return
        try:
