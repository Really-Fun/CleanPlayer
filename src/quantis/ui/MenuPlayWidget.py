...
class PlayMenu(QWidget):
    ...
    def __init__(self, context: AppContext, parent=None):
        ...
        self.btn_repeat = self._btn(get_asset_path("assets/icons/repeat.svg"), 30)
        self.btn_repeat.setObjectName("repeatButton")
        self.btn_repeat.setProperty("state", "off")
        self.btn_repeat.setToolTip("Повтор: выкл")

        self.btn_prev = self._btn(get_asset_path("assets/icons/prev.svg"), 34)
        self.btn_play = self._btn(get_asset_path("assets/icons/play.svg"), 40)
        self.btn_next = self._btn(get_asset_path("assets/icons/next.svg"), 34)
        self.btn_wave = self._btn(get_asset_path("assets/icons/radio.svg"), 30)
        ...
        self.btn_download = self._btn(get_asset_path("assets/icons/download.svg"), 30)
    ...
    async def _on_track_changed(self, track) -> None:
        ...
        self.btn_play.setIcon(QIcon(get_asset_path("assets/icons/pause.svg")))
    ...
    async def toggle_playback(self):
        if self.player.is_playing():
            self.player.pause()
            self.btn_play.setIcon(QIcon(get_asset_path("assets/icons/play.svg")))
            return
        self.player.resume()
        self.btn_play.setIcon(QIcon(get_asset_path("assets/icons/pause.svg")))
    ...
    async def play_previous_track(self):
        ...
        await self.set_track(track)
        self.btn_play.setIcon(QIcon(get_asset_path("assets/icons/pause.png")))
