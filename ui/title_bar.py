...
# Импортируем твою функцию asset_path
...
class CustomTitleBar(QWidget):
    def __init__(self, parent, title="Quantis"):
        ...
        logo_path = asset_path("assets/icons/logo_title.png") # Уменьшенная версия твоего лого
        min_icon_path = asset_path("assets/icons/minimize.svg")
        close_icon_path = asset_path("assets/icons/close.svg")
